...
export const InfoPieceBlock = ({
    ...
    return (
        <InfoPieceBlockStyled $loading={false}>
            <BlockFormStyled onSubmit={handleSubmit}>
                <InfoPiece
                    editable={edit}
                    title='Отопление'
                    text={formData.heating}
                    options={Object.values(HeatingType)}
                    fieldName={formData.heating}
                    onChange={v => {
                        handleChange('heating', v)
                    }}
                />
                <InfoPiece
                    title='Водоснабжение'
                    text={formData.waterSupply}
                    editable={edit}
                    fieldName={formData.waterSupply}
                    options={Object.values(WaterSupply)}
                ...
                <InfoPiece
                    ...
                    editable={edit}
                    options={Object.values(SewerageType)}
                    fieldName={formData.sewerage}
